        ...
        <div class="mt-3">
            ...
            <div class="modal modal-top fade" id="modal-form" tabindex="-1">
                <div class="modal-dialog">
                    <form action={{ url('category') }} class="form-category modal-content" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Gambar (130 x 100 px)</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning mb-3 modal-tambah"
                                    href="{{ url('category/' . $category->id) }}">Lihat</a>
