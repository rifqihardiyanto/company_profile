        ...
        <div class="mt-3">
            ...
            <div class="modal modal-top fade" id="modal-form" tabindex="-1">
                <div class="modal-dialog">
                    <form action={{ url('management') }} class="form-slider modal-content" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" aria-label="With textarea" placeholder="Deskripsi" name="deskripsi_3"></textarea>
                                </div>
                                <div class="mb-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning mb-3 modal-tambah"
                                    href="{{ url('management/' . $data->id) }}">Lihat</a>
                                <form action="{{ url('management/' . $data->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
