                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="pr-portfolio-inner-item position-relative">
                            <span class="pr-item-bg1 position-absolute"><img src="{{ asset('uploads/' . $data->category->gambar_1) }}"
                                    alt=""></span>
                            <span class="pr-item-bg2 position-absolute"><img src="{{ asset('uploads/' . $data->gambar_1) }}"
                                    alt=""></span>
                            <div class="pr-portfolio-img">
                                <img src="{{ asset('uploads/' . $data->gambar_1) }}" alt="">
                            </div>
                            <div class="pr-portfolio-text headline pera-content">
                                <h3><a href="portfolio-details.html">{{ $data->nama_produk }}</a></h3>
                                <span>{{ $data->category->nama_kategori }}</span>
                                <div class="pr-portfolio-btn">
                                    <a href="{{ url('home/produk/' . $data->id) }}"><i class="far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
